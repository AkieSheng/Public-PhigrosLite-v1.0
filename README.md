## 游戏介绍
这是一款轻量版的Phigros音乐游戏，为保证游戏难度，游戏虽仅包含两种音符但分布了8个轨道，从左到右分别由'A''S''D''F''J''K''L'';'8个按键控制。作为玩家，你也可以在设置界面自由绑定轨道按键并调整音频偏移，当音符到达判定线时候按下对应轨道的按键可获得分数，分数判定为S,A,B,C,D五档，请享受旋律与游戏，取得高分吧！
